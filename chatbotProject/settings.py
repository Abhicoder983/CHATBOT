...
SECRET_KEY = 'django-insecure-q#tikxlvbu2(nk06^!)w0ozh*3(l@mhwfm=fj!1azpro64wpt^'
...
INSTALLED_APPS = [
    ...
    'chatbotProject.apps.MongoAdminConfig',
    'chatbotProject.apps.MongoAuthConfig',
    'chatbotProject.apps.MongoContentTypesConfig',
